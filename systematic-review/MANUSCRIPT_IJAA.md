...
The World Health Organization placed carbapenem-resistant *A. baumannii* (CRAB) at the apex of its priority pathogens list ("Priority 1: Critical") in 2017 and reaffirmed this in 2024 [54]. The US CDC has classified CRAB as an "urgent" threat [55,56]. Global Burden of Antimicrobial Resistance estimates attribute approximately 110,000 directly caused and 470,000 associated deaths to *Acinetobacter* spp. in 2019 [57], placing the genus among the four leading bacterial drivers of resistance-attributable mortality, and the most therapeutically intractable Gram-negative ESKAPE member [58].
...
This review was designed, conducted and reported in accordance with PRISMA 2020 [59], the PRISMA-S extension [60] and the Synthesis Without Meta-analysis (SWiM) guideline [61]. The completed PRISMA 2020 checklist is provided as Supplementary S1.
...
Methodological quality and risk of bias were appraised at the field level using design-appropriate frameworks as reference standards: a modified CRIS checklist for in vitro studies [62]; SYRCLE [63] supplemented by ARRIVE 2.0 [64] for animal studies; JBI Critical Appraisal Checklists [65] and Newcastle-Ottawa Scale [66] for observational clinical work; a CHARMS-modified checklist [67] for in silico studies; and MIQE [68] plus MINSEQE-aligned criteria for omics. Cochrane RoB 2.0 [69] was not applied because no randomised trial of a QS-targeting agent in *A. baumannii* was identified. Field-level patterns are summarised in §3.9 and visualised in Figure 5.
...
Studies were grouped a priori by intervention class (natural product, synthetic small molecule, enzymatic QQ, peptide/AMP, bacteriophage, nanoparticle, repurposed drug, antibody/vaccine, genetic perturbation) crossed with outcome domain and experimental system. The synthesis is narrative with structured outcome tabulation per SWiM [61]; heterogeneity in strain background, intervention concentrations, assays and outcome definitions precluded formal pooled meta-analysis. Effect sizes are summarised by intervention class in Table 2 and aggregated by outcome domain in §3.8. Sub-analyses by strain, assay format and isolate resistance phenotype are reported in §3.7-§3.9.

### 2.9 Publication bias

Funnel-plot asymmetry was considered for the largest outcome subgroup (biofilm inhibition); heterogeneity of effect-size metrics, sub-MIC concentration choices and assay formats precluded construction of a comparable effect-estimate set sufficient for Egger's regression [70]. Small-study effects, positive-result skew and selective reporting are assessed narratively in §3.9.2 and §4.6.

### 2.10 Reporting framework

The review is reported per PRISMA 2020 [59], PRISMA-S [60] and SWiM [61]. The PRISMA-NMA extension was not applicable. Formal GRADE certainty grading was not applied at the body-of-evidence level because heterogeneity precluded quantitative pooling; certainty of mechanistic, preclinical and translational claims is discussed narratively in §4. All data-extraction forms, code, search logs and intermediate datasets are deposited on the project repository.
...
*P. aeruginosa* LasI/RhlI signals modulate *A. baumannii* biofilm in mixed cultures with reciprocal AHL effects [35]. MvfR (PqsR) is central in co-culture, and pharmacological MvfR inhibition partially restores *A. baumannii* survival without altering *P. aeruginosa* abundance [36,37]. Indole produced by *A. baumannii* AbiS represses *P. aeruginosa* QS and T3SS, defining a bidirectional axis [38,39]. Carnosol disrupts AbiR-promoter binding (KD = 0.3 μM) and reduces biofilm, motility and cytotoxicity by 25-85% [26]. Cross-kingdom interactions with *Candida albicans* facilitate *A. baumannii* pneumonia [40]. Engineered lactonases reduce inter- and intra-species signalling in mixed-species biofilms [8,41].

#### 3.3.7 Open mechanistic questions

Detailed in S9.1, the principal unresolved issues are: prevalence of functional *abiS*/*abiR* across IC1/IC2 clones [42]; absence of confirmed AI-2/DSF/PQS equivalents; unidentified c-di-GMP effectors beyond EF-P; uncharacterised PmrAB-QS interface; absent in vivo direct evidence for polymicrobial AHL exchange; no genome-wide AbaR ChIP-seq dataset [4]; and mechanistically thin links to small RNAs and nucleoid-associated proteins [43,44].
...
Of 340 records, 247 (73%) report at least one candidate intervention with a defined or implied QS mechanism. Eight classes are sufficiently represented for comparative analysis: natural products (n=52), bacteriophages (n=67), peptides (n=31), QQ enzymes (n=30), nanoparticles (n=22), synthetic small molecules (n=20), repurposed FDA-approved drugs (n=14) and antibody/vaccine constructs (n=11). Translational maturity is uneven: more than half of natural-product and synthetic-compound studies remain in vitro or in silico, whereas ~40% of phage and most QQ-enzyme reports include at least a *Galleria mellonella*, zebrafish or murine validation step. Per-class structural and chemical details are provided in Supplementary S9.2.

#### 3.4.1 Natural products and phytochemicals

Plant- and microbe-derived QSIs dominate numerically, spanning diverse natural-product chemotypes (terpenoids, diterpenes, alkaloids, flavonoids, phenolic acids) reviewed in [Cui_2025_2; Wei_2025; DudaMadej_2025]. Three mechanisms recur: signal mimicry and AbaR/AbaI antagonism, with dual-target docking pipelines prioritising lead hits [BellI_2025; Aruwa_2025]; signal degradation; and transcriptional repression of *abaI/abaR*. Effect sizes are heterogeneous but consistent in direction: glabridin reduced *abaI* and *abaR* expression by 39.1% and 25.2% (P<0.001) with 27.4% biofilm inhibition at 1/2 MIC [Lin_2023]; carnosol at 100 μM suppressed *abaI/abaR/abiS/abiR* promoter activity, reduced biofilm phenotypes by 25-85%, and improved *G. mellonella* survival [Cui_2025]; 7-hydroxyindole retained anti-biofilm activity at 1/64 MIC [Li_2025]; *Paederia foetida* extract produced dose-dependent biofilm reduction (MIC 7.81 mg/mL) [Santajit_2025]; peppermint extract shifted 64% of clinical isolates from strong to weak biofilm phenotype at 2× MIC [MajidiFard_2025]. Additional actives are catalogued by [Zeng_2023; Mohamad_2023; ChvezHernndez_2023; Ribeiro_2024; Sorenson_2025]. Translational hurdles include compositional variability of essential oils, poor aqueous solubility and low oral bioavailability; only 13 of 52 natural-product studies advanced to an animal model, and none reported a controlled clinical endpoint [NaseefPathoor_2024].

#### 3.4.2 Synthetic small-molecule QSIs

Synthetic QSIs span halogenated furanones, AHL analogues, indole derivatives and structure-based virtual-screening hits. Stacy and colleagues established that non-native AHLs antagonise AbaR with EC50 values approaching the native ligand and that five library members reduced biofilm in vitro [Stacy_2012; Stacy_2012_2; Garner_2012]. The most translationally framed recent work is [Beasley_2025], which assembled 36 compounds with ≥50% QS inhibition at ≤10 µM and prioritised levamisole, azaguanine-8, ketoprofen, indomethacin and piroxicam for antibiotic-enhancement testing; levamisole at 1/8 MIC achieved >50% biofilm inhibition in 85% of *A. baumannii* strains. Indole derivatives are productive: 37 of 46 synthesised indoles displayed activity against XDR-AB (MIC 64-1024 µg/mL) [Li_2025]. Structure-based design has identified dual AbaI/AbaR hits with favourable ADMET profiles [BellI_2025], and analogous approaches target BfmR (RstA) and TetR-family regulators [Aruwa_2025; Alagesan_2025]. CRISPR-Cas-mediated endogenous AbaI suppression provides genetic proof that AbaI is a tractable single-protein target [Wang_2022_2]. No synthetic AbaR antagonist has entered IND-enabling studies, primarily due to cytotoxicity in eukaryotic counterscreens and limited in vivo PK [Qvortrup_2019; Zhong_2021; Santajit_2022].

#### 3.4.3 Bacteriophage therapy with QS implications

Phage therapy is the largest and most rapidly expanding class, with 14 new isolation reports in 2024-2025. Lytic phages exert QS-relevant effects indirectly by collapsing local cell density and directly by dispersing biofilm via depolymerases. Representative recent isolates include phage vB-AbaM-fThrA [Arazi_2025], depolymerase-encoding vB_AbaM_AB4P2 (52% single-agent biofilm reduction) [Su_2025], the ΦZC2/ΦZC3 pair (~5 log10 reduction in A549 co-culture) [Essam_2025], Saclayvirus vB_AbaM_P1 [Li_2024] and a Phapecoctavirus active in A549 epithelia [Wintachai_2022]. The rationally designed 3014/3098 cocktail against an XDR Lausanne burn isolate attained calculated virulence Vp=0.62 and lifted *G. mellonella* survival significantly above single-phage controls (P<0.001) [deVilliersdelaNoue_2025]. Single-dose intratracheal phage aerosolisation reduced murine pulmonary burden by ~1 log10 at 24 h [Wienhold_2021]. Hydrogel-formulated phages enhanced burn-wound healing [Elshamy_2025]. Phage-antibiotic synergy provides the strongest mechanistic case for genuine QS interference: endolysin-derived peptides showed >90% inhibition with colistin, and the fused construct lysAB-vT2 reached FIC = 0.25 [Rothong_2024; Sitthisak_2023]. Further phages with in vitro and animal validation are reported by [Mardiana_2023; Jiang_2024_2; Peters_2023; VeraJauregui_2025; Tan_2024; Erol_2024; Benyamini_2024; Cook_2024], and engineered inhalable spray-dried powders anticipate pulmonary deployment [Yan_2021; YuCheng_2025]. The Lausanne compassionate-use experience and the Styles series [Styles_2020] represent the closest approaches to clinical translation. Capsular polysaccharide diversification and natural transformation threaten durable efficacy and motivate cocktail paradigms [Correa_2024; Godeux_2022].

#### 3.4.4 Nanoparticle-formulated QSIs

Twenty-two studies use nanocarriers as QS-active agents or delivery vehicles. The clearest single advance is staphyloxanthin-loaded niosomes (92.7% entrapment) reducing biofilm by 68-88%, motility by 66.7-94.5% and mature biofilm by 82% [Nosair_2025]. Silver nanoparticles (MIC 4-25 µg/mL) attenuated QS-regulated phenotypes [Hetta_2021]. Hypericin nanoparticles with D-tryptophan and photo-sonodynamic activation achieved FIC = 0.5 [Pourhajibagher_2023]. Au@MSN core-shell systems with vanillic acid enabled photothermal heating to 60°C in 12 s [Maisch_2022]. Additional polymeric, lipid and curcumin platforms are documented by [Siddique_2022; Pourhajibagher_2022; Bhowmik_2023; Natsheh_2023]. The rationale is improved biofilm penetration, sustained sub-MIC exposure and protection of labile cargo. Translation barriers include protein-corona formation, batch reproducibility and near-universal absence of PK and biodistribution data [Rajapaksha_2023; Hetta_2025].

#### 3.4.5 Antimicrobial peptides and quorum-quenching enzymes

Of 31 peptide and 30 QQ-enzyme studies, the majority remain in vitro, with ~8 advancing to invertebrate or rodent models. Endolysin-derived peptides PE04-1/PE04-1(NH2)/PE04-2 act on outer membrane and biofilm matrix, with strong colistin synergy [Rothong_2024]. Octopromycin (MIC 50 µg/mL) collapses biofilm architecture and down-regulates QS genes at sub-MIC [Rajapaksha_2023]. X33 oligopeptide reduced biofilm by 23-30% [Lu_2024]. QQ enzymes target the AHL signal: PvdQ acylase reduces biofilm formation [Vogel_2022]; MomL degrades 10 µM 3-OH-C12-HSL at ≥1 µg/mL and increases biofilm-state antibiotic susceptibility [Zhang_2017]; AaL has unusually low KM (10-80 µM) [Bergonzi_2018]; Aii20J is active at 20 µg/mL [Mayer_2020]; and the endogenous α/β-hydrolase AidA is redox-regulated, with reciprocal *abaI* up-regulation under H2O2 [Lpez_2017_2]. Engineered SsoPox A variants confirm protein-engineering tractability [Gonzales_2024]. Surface-tethered QQ activity offers an engineering route that avoids systemic enzyme exposure and immunogenicity [Rodgers_2021].

#### 3.4.6 Drug repurposing

Fourteen repurposing studies target *A. baumannii* QS using approved pharmacopoeia. Nitroimidazoles, repositioned by triphasic in silico/in vitro/in vivo workflow, suppress biofilm and virulence in MDR isolates with preserved PK and established safety [Khafagy_2025]. The [Beasley_2025] screen identified piperacillin combined with NSAIDs (ketoprofen, indomethacin, piroxicam) as the broadest QS-enhanced mixture; levamisole alone achieved >50% biofilm reduction in 85% of isolates at 1/8 MIC. [Seleem_2020] documented sub-MIC QSI activity for azithromycin, erythromycin, propranolol, levamisole and chloroquine. Statin and NSAID repurposing as low-dose QS modulation is reviewed by [Zhong_2021; Panda_2022]. The translational appeal is concrete: PK/PD parameters are largely known and combinations with last-line antibiotics (colistin, tigecycline, sulbactam-durlobactam) offer a near-term path to combination-therapy trials [Jha_2022; Zore_2022].

#### 3.4.7 Vaccines and antibody-based approaches

Eleven studies address immunological strategies, principally outer-membrane vesicle (OMV) preparations, AbaI/AbaR-derived antigens and QS-regulated virulence-factor subunits. Reviews catalogue OMV, capsular polysaccharide and monoclonal antibody candidates, with AbOmpA, Bap and BfmRS as QS-regulated antigen sources [Rajangam_2024; Mendes_2023; Roy_2022]. No *A. baumannii*-specific licensed product exists [Hetta_2025]. Antibody-based blockade of QS signal reception, including conjugate constructs targeting 3-OH-C12-HSL itself, has been proposed [Lazar_2021; Venkateswaran_2023]. Whole-blood induction data inform vaccine antigen prioritisation [Ghavanloughajar_2025]. The field is predominantly preclinical, with OMV vaccines furthest advanced.

#### 3.4.8 Cross-class synthesis

Three patterns emerge. Animal-model evidence concentrates in phage, QQ-enzyme and nanoparticle subspaces, while natural-product and synthetic-compound classes show a heavier in vitro/in silico tail. Reported effect sizes cluster around 50-90% biofilm inhibition at sub-MIC concentrations across diverse chemotypes — suggesting either a ceiling effect imposed by biofilm architecture or convergence on biofilm-staining endpoints. The most consistent translational gap is the absence of *A. baumannii*-specific QS pharmacodynamic biomarkers and the heterogeneity of biofilm readouts; resistance-development data under repeated sub-MIC QSI exposure are reported in only a handful of studies, despite the lower-selection rationale that underpins anti-virulence therapy.
...
51. Arazi P, Skurnik M, Mohsenipour Z, Abtahi HR, Jahanbin B, Kianian F, et al. Genomic and functional characterization of a novel lytic phage vB-AbaM-fThrA with anti-biofilm activity against CR-MDR Acinetobacter baumannii. *BMC microbiology*. 2025;26(10):6987-98. doi:10.1186/s12866-025-04525-z PMID:41420149 PMCID:PMC12859838
52. de Villiers de la Noue H, Golliard G, Vuattoux X, Resch G. Rational Design of a Potent Two-Phage Cocktail Against a Contemporary Acinetobacter baumannii Strain Recovered from a Burned Patient at the Lausanne University Hospital. *Viruses*. 2025;17(11):6987-6998. doi:10.3390/v17111441 PMID:41305464 PMCID:PMC12656882
53. Elshamy et al. Genomic analysis and preclinical evaluation of two hydrogel-formulated novel virulent phages isolated against a carbapenem-resistant Acinetobacter baumannii. *Virology*. 2025. doi:10.1016/j.virol.2025.110676 PMID:40916327
54. World Health Organization. *WHO Bacterial Priority Pathogens List, 2024: Bacterial pathogens of public health importance to guide research, development, and strategies to prevent and control antimicrobial resistance*. Geneva: WHO; 2024. https://www.who.int/publications/i/item/9789240093461
55. Centers for Disease Control and Prevention. *Antibiotic Resistance Threats in the United States, 2019*. Atlanta: U.S. Department of Health and Human Services, CDC; 2019. https://www.cdc.gov/drugresistance/biggest-threats.html
56. Centers for Disease Control and Prevention. *Antimicrobial Resistance Threats — 2024 Update*. Atlanta: U.S. Department of Health and Human Services, CDC; 2024. https://www.cdc.gov/antimicrobial-resistance/data-research/threats/index.html
57. Murray CJL, Ikuta KS, Sharara F, Swetschinski L, Robles Aguilar G, Gray A, et al. Global burden of bacterial antimicrobial resistance in 2019: a systematic analysis. *Lancet*. 2022;399(10325):629–55. doi:10.1016/S0140-6736(21)02724-0
58. Rice LB. Federal funding for the study of antimicrobial resistance in nosocomial pathogens: no ESKAPE. *J Infect Dis*. 2008;197(8):1079–81. doi:10.1086/533452
59. Page MJ, McKenzie JE, Bossuyt PM, Boutron I, Hoffmann TC, Mulrow CD, et al. The PRISMA 2020 statement: an updated guideline for reporting systematic reviews. *BMJ*. 2021;372:n71. doi:10.1136/bmj.n71
...
61. Campbell M, McKenzie JE, Sowden A, Katikireddi SV, Brennan SE, Ellis S, et al. Synthesis without meta-analysis (SWiM) in systematic reviews: reporting guideline. *BMJ*. 2020;368:l6890. doi:10.1136/bmj.l6890
62. Krithikadatta J, Gopikrishna V, Datta M. CRIS Guidelines (Checklist for Reporting In-vitro Studies): A concept note. *J Conserv Dent*. 2014;17(4):301–4. doi:10.4103/0972-0707.136338
63. Hooijmans CR, Rovers MM, de Vries RB, Leenaars M, Ritskes-Hoitinga M, Langendam MW. SYRCLE's risk of bias tool for animal studies. *BMC Med Res Methodol*. 2014;14:43. doi:10.1186/1471-2288-14-43
64. Percie du Sert N, Hurst V, Ahluwalia A, Alam S, Avey MT, Baker M, et al. The ARRIVE guidelines 2.0: Updated guidelines for reporting animal research. *PLoS Biol*. 2020;18(7):e3000410. doi:10.1371/journal.pbio.3000411
65. Joanna Briggs Institute. *JBI Manual for Evidence Synthesis*. Aromataris E, Munn Z (eds). 2020. doi:10.46658/JBIMES-20-01
66. Wells GA, Shea B, O'Connell D, Peterson J, Welch V, Losos M, Tugwell P. The Newcastle-Ottawa Scale (NOS) for assessing the quality of nonrandomised studies in meta-analyses. Ottawa Hospital Research Institute; 2014. http://www.ohri.ca/programs/clinical_epidemiology/oxford.asp
67. Moons KGM, de Groot JAH, Bouwmeester W, Vergouwe Y, Mallett S, Altman DG, et al. Critical appraisal and data extraction for systematic reviews of prediction modelling studies: the CHARMS checklist. *PLoS Med*. 2014;11(10):e1001744. doi:10.1371/journal.pmed.1001744
68. Bustin SA, Benes V, Garson JA, Hellemans J, Huggett J, Kubista M, et al. The MIQE guidelines: minimum information for publication of quantitative real-time PCR experiments. *Clin Chem*. 2009;55(4):611–22. doi:10.1373/clinchem.2008.112797
69. Sterne JAC, Savović J, Page MJ, Elbers RG, Blencowe NS, Boutron I, et al. RoB 2: a revised tool for assessing risk of bias in randomised trials. *BMJ*. 2019;366:l4898. doi:10.1136/bmj.l4898
...
---
*Manuscript word count: 13,320 | Cited references: 70*
